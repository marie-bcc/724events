  ...
  return <>
    ...
    <main>
      ...
      <section className="EventsContainer">
        <h2 data-testid="Nos réalisations" className="Title">Nos réalisations</h2>
        <EventList />
      </section>
      <section id="PeoplesContainer">
        <h2 data-testid="Notre équipe" className="Title">Notre équipe</h2>
